...
The analysis is done in [this Jupyter Notebook.](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb)

### Contents:
- [2017 Data Import & Cleaning](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Data-Import-and-Cleaning)
- [2018 Data Import and Cleaning](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#2018-Data-Import-and-Cleaning)
- [Exploratory Data Analysis](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Exploratory-Data-Analysis)
- [Data Visualization](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Visualize-the-data)
- [Descriptive and Inferential Statistics](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Descriptive-and-Inferential-Statistics)
- [Outside Research](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Outside-Research)
- [Conclusions and Recommendations](../project-1-sat-act-analysis/code/sat-act-analysis.ipynb#Conclusions-and-Recommendations)
...
The data files are found [here](../project-1-sat-act-analysis/data).
